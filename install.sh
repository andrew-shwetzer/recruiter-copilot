...
echo ""
echo -e "    ${CYAN}/recruiter:setup${RESET}        Set up your profile + API keys"
echo -e "    ${CYAN}/recruiter:connect${RESET}      Connect email, ATS, calendar"
echo ""
echo "  8 skills work free. Add API keys to unlock the full suite."
echo ""
echo -e "  ${CYAN}/recruiter:help${RESET} for the full skill list."
echo "  ────────────────────────────────────────────────────"
echo ""
