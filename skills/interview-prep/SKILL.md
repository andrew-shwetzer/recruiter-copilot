...
# /interview-prep — Identity Verification Questions
...
The user invokes: `/interview-prep <candidate name or LinkedIn URL>`

Examples:
- `/interview-prep Jane Smith`
- `/interview-prep https://linkedin.com/in/janesmith`
...
> "No RapidAPI key found. With a key, I'd pull the candidate's live LinkedIn profile for precise project details, company histories, and team sizes. Running on candidate file + WebSearch now. Run `/setup` to add your RAPIDAPI_KEY for higher-precision questions."
...
- Run `/outreach [name]` to draft the candidate outreach after the interview.
- If concerns remain after the interview, run `/verify [name]` for a deeper background check.
