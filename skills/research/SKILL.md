...
The user will invoke this as: `/research <Company Name> [--deep]`
...
- Run `/signals [Company Name]` to check for active hiring signals and score this as a lead.
- Run `/outreach [Company Name]` to draft a cold email using the outreach angle above.
- If you want to reach a specific person there, run `/candidate-msg [name]` for candidate-side outreach.
