...
# /candidate-msg — Candidate Outreach
...
The user will invoke this as: `/candidate-msg <candidate name>` or `/candidate-msg <LinkedIn URL>`
...
- Ready to reach this person at scale? Run `/signals` on their current company to understand the competitive landscape.
- Need to reach their hiring manager instead? Run `/outreach [Company Name]` for the hiring manager sequence.
- Want a full intelligence brief on their current employer? Run `/research [Company Name]`.
