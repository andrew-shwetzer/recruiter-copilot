...
# /outreach — Cold Outreach Drafter
...
The user will invoke this as: `/outreach <Company Name> [--candidate] [--tone warm|professional|casual]`

- Default: outreach FROM recruiter TO hiring manager at the target company.
- `--candidate`: switch to candidate-side outreach (recruiter → passive candidate). Use `/candidate-msg` instead — this flag redirects there.
...
If you cannot find a specific, observable hook, tell the user: "I couldn't find a specific hook for [Company]. Run `/research [Company]` first, or give me a recent signal to anchor the email."
...
- Want to reach a specific person at [Company]? Run `/candidate-msg [name]` for personalized candidate outreach.
- Need more context before sending? Run `/research [Company Name]` to deepen the brief.
- Working through a list? Run `/signals` on your next batch of target companies.
