...
# /signals — Hiring Signal Detection
...
The user will invoke this as: `/signals <Company Name>` or `/signals Company A, Company B, Company C`
...
- For your top hits, run `/research [Company Name]` to build a full intelligence brief before outreach.
- Ready to reach out? Run `/outreach [Company Name]` to draft the cold email sequence.
